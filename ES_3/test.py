...
if __name__ == "__main__":
    ...
    # Test 1 (Rosenbrock)
    gradient = [x1_1, x2_1]
    print(steepest(funct, gradient, np.array([5, 3]), 0.1, 0.81, 0.0000001,100000))   # with the correct selection of parameters on this test, the method shows high accuracy
